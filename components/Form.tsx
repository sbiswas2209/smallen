        ...
        id === "" ? (
          ...
          >
            <input
              ...
              className="hover:shadow-xl focus:outline-none ring border-blue-700 rounded-md lg:col-start-2 lg:col-span-3 sm:row-start-1 sm:row-span-1 m-4 p-4"
            ...
            <button
              ...
              onSubmit={shortenUrl}
            >
              <p className="group-hover:text-gray-900 text-white">Smallen</p>
            </button>
          </form>
        ) : (
