...
const Navbar: React.FC<NavbarProps> = () => {
  return (
    <nav className="font-sans flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 bg-white shadow sm:items-baseline min-w-full">
      <div
